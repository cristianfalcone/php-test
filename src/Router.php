...
/**
 * Router — Abstract base class for middleware routing (CLI/HTTP).
 *
 * Subclasses must implement:
 * - matches(string $prefix, string $target): bool
 * - normalize(string $path): string
 * - defaultNotFound(): callable
 * - defaultException(): callable
 */
abstract class Router
{
    ...
    /**
     * Constructor to initialize routing handlers.
     */
