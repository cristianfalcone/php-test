...
/**
 * HttpCore — Dependency-free HTTP router (implementation class).
 *
 * This is the concrete implementation. Use Http facade for static access.
 * Use this class directly in tests: $http = new HttpCore();
 */
final class HttpCore extends Router
{
...
/* ================================================
 *  Http Facade — Static interface
 * ================================================ */

namespace Ajo;

/**
 * Http — Static facade for HttpCore.
 *
 * Usage:
 *   Http::get('/users', fn() => ['users' => $users]);
 *   Http::post('/users', fn() => ['created' => true]);
 *   Http::dispatch();
 *
 * For testing, use HttpCore directly:
 *   $http = new HttpCore();
 *   $http->get('/test', fn() => ['ok' => true]);
 */
final class Http
{
    use Facade;
